...
export class CDPBridge implements IBrowserFactory {
  ...
  async connect(opts?: { timeout?: number; session?: string; cdpEndpoint?: string; contextId?: string; idleTimeout?: number; windowMode?: 'foreground' | 'background'; surface?: 'browser' | 'adapter'; siteSession?: 'ephemeral' | 'persistent'; access?: BrowserCommandAccess }): Promise<IPage> {
